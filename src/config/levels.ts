...
export const LEVELS: LevelConfig[] = [
  ...
  },
  {
    id: 'level4',
    levelNumber: 4,
    title: 'THE DISCO BALLROOM',
    dateDisplay: 'FINAL EVENT',
    subtitle: 'Ballroom Hub • 3 Duck Mini-Games • 3D Gift Reveal',
    environmentName: 'Pixel Disco Ballroom Hub',
    song: songs.level4,
    collectibleName: '3D SPECIAL GIFT',
    visualIntensity: 1.00,
    difficulty: 'FREE CHOICE • 3 RIVALS',
    instructions: [
      'Enter the Grand Ballroom and challenge 3 duck rivals in any order.',
      'Defeat Prof. Quill (Typing), Dr. Bones (Puzzle), and Billy the Quack (Shooter).',
      'Break all 3 seals to unlock the 3D gift box and read your special birthday letter!',
    ],
  },
];
