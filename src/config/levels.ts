...
export const LEVELS: LevelConfig[] = [
  {
    id: 'level1',
    levelNumber: 1,
    title: 'QUACK CHECK-IN',
    dateDisplay: '20 SEP 2026',
    subtitle: 'Club Entrance • Learn the Rhythm Code',
    environmentName: 'Neon Club Entrance',
    song: songs.level1,
    collectibleName: 'NEON FEATHER',
    collectibleKey: 'neonFeather',
    visualIntensity: 0.25,
    difficulty: 'FUNK GROOVE • 108 BPM',
    instructions: [
      'Listen to the call: "1, 2, 3... QUACK!"',
      'Tap SPACEBAR or CLICK on the target beat.',
      'Watch out for syncopated and offbeat check-ins!',
    ],
  },
  {
    id: 'level2',
