    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="w-full max-w-md bg-[#0e0a1f] border border-fuchsia-500/40 rounded-2xl p-6 shadow-[0_0_40px_rgba(236,72,153,0.3)] select-none">
        <div className="flex items-center justify-between pb-4 border-b border-white/10 mb-6">
          ...
          <button
            onClick={onClose}
            className="text-white/60 hover:text-white text-lg px-2 py-0.5 rounded bg-white/10"
          >
            ✕
          </button>
        </div>
        ...
        <button
          onClick={onClose}
          className="w-full mt-8 py-3 rounded-xl bg-gradient-to-r from-fuchsia-600 to-pink-600 hover:from-fuchsia-500 hover:to-pink-500 font-disco tracking-widest text-sm text-white font-bold shadow-[0_0_20px_rgba(236,72,153,0.5)] transition-all"
        >
          CONFIRM & CLOSE
        </button>
      </div>
